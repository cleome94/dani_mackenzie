...
<body>
    ...
    <main class="content">
        <form name="qna_form" action="insert.php" method="post" onsubmit="return qna_check()">
            <fieldset class="qna_set">
                ...
                <p><textarea id="n_answer" name="n_answer" class="n_answer" placeholder="문의사항에 대한 답변을 해주세요."></textarea></p>
                <?php } else{ ?>
                    <p class="answer1">
                        <select name="answer" id="answer" class="answer">
                            <option value="답변대기">답변대기</option>
